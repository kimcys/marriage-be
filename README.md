...
The Docker build and Compose defaults pin the upstream OCR checkout to `652ad3f117ee2b9ffabad3e643e4549af6c7e1ce`, which matches the current `origin/main` of `marriage-ocr`.
