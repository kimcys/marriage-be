...
The Docker build and Compose defaults pin the upstream OCR checkout to `8f3ce9fc2e6b63b8768861b8d3c3e99da57f53f3`, which matches the current `origin/main` of `marriage-ocr`.
