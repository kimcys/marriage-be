...
The Docker build and Compose defaults pin the upstream OCR checkout to `2f14dee42ef42c3d14a0c9490f248830b27c97dd`, which matches the current `origin/main` of `marriage-ocr`.
