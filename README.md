...
The Docker build and Compose defaults pin the upstream OCR checkout to `210de13cf1cffbca2f0ffcf6c00757ba82ff8776`, which matches the current `origin/main` of `marriage-ocr`.
