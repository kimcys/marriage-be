...
The Docker build and Compose defaults pin the upstream OCR checkout to `d9584280852d66ddbe8363b813fff3ae643bf180`, which matches the current `origin/main` of `marriage-ocr`.
