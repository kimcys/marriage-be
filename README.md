...
The Docker build and Compose defaults pin the upstream OCR checkout to `d4ff34a0415567a86106602f6cf3ecb464e04d4f`, which matches the current `origin/main` of `marriage-ocr`.
