...
The Docker build and Compose defaults pin the upstream OCR checkout to `d0a0a0bb450404c4539bd0eb75ef882d6b1e53ed`, which matches the current `origin/main` of `marriage-ocr`.
