...
The Docker build and Compose defaults pin the upstream OCR checkout to `916ddd0c30a653693bd40be2a150b10cdadc7e6f`, which matches the current `origin/main` of `marriage-ocr`.
