...
The Docker build and Compose defaults pin the upstream OCR checkout to `0c63526a981d06445e471f2632f5181ee5d4d7fd`, which matches the current `origin/main` of `marriage-ocr`.
