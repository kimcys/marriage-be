...
The Docker build and Compose defaults pin the upstream OCR checkout to `e84d367a61de18fd6d317e3f1bb2bff36f1408ae`, which matches the current `origin/main` of `marriage-ocr`.
