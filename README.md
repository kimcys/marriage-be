...
The Docker build and Compose defaults pin the upstream OCR checkout to `5fa36d2e5295c38c7e7c386cd2923a52f6c07e6f`, which matches the current `origin/main` of `marriage-ocr`.
