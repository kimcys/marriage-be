...
The Docker build and Compose defaults pin the upstream OCR checkout to `6f4ead196d2ddd8196d5fb9e06e6398691d4a6da`, which matches the current `origin/main` of `marriage-ocr`.
