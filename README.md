...
The Docker build and Compose defaults pin the upstream OCR checkout to `cc1c9d5bd7a6ed5d6e0d72aae73b6c4e3af66106`, which matches the current `origin/main` of `marriage-ocr`.
