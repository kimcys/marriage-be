...
The Docker build and Compose defaults pin the upstream OCR checkout to `beaede7194f35abe706143fd5ad931dccc7d801b`, which matches the current `origin/main` of `marriage-ocr`.
