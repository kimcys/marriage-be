...
The Docker build and Compose defaults pin the upstream OCR checkout to `0614ec6ed8c6c02b699e0540c35920c770f00eac`, which matches the current `origin/main` of `marriage-ocr`.
