...
The Docker build and Compose defaults pin the upstream OCR checkout to `21d284b0aeb54267de03ede4727205e6d0a4c1f6`, which matches the current `origin/main` of `marriage-ocr`.
