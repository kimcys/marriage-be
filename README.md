...
The Docker build and Compose defaults pin the upstream OCR checkout to `3bfe0d6849bc5199dc8449238a21ba26adb39e92`, which matches the current `origin/main` of `marriage-ocr`.
