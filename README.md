...
The Docker build and Compose defaults pin the upstream OCR checkout to `144be2832f8e4d1827af8ac37517d017475e3b98`, which matches the current `origin/main` of `marriage-ocr`.
