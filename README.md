...
The Docker build and Compose defaults pin the upstream OCR checkout to `6faae7e755ac30733bbf81709965604d69725444`, which matches the current `origin/main` of `marriage-ocr`.
